...
>(({ children, className, ...props }, ref) => {
  ...
  return (
    <HoverSliderContext.Provider value={{ activeSlide, changeSlide }}>
      <section ref={ref as any} className={className} {...props}>{children}</section>
    ...
    >
      {characters.map((char, charIndex) => (
        ...
        >
          ...
          >
            <motion.span
              className="inline-block text-[var(--color-text-secondary)] opacity-50"
              initial={{ y: "0%" }}
            ...
            <motion.span
              className="absolute left-0 top-0 inline-block text-[var(--color-accent)] font-bold opacity-100"
              initial={{ y: "110%" }}
